...
| `textures.py` | **Las texturas de madera y empedrado de la piel UI-W** (`wood-planks.png`, `cobble.png`, `metal.png`, el grabado de la portada en dos tintas y el logotipo de hierro del título, uno por lengua): semilla fija, ruido periódico, sin costura. Existe porque la madera en CSS se queda corta («úsalo para texturas en general, CSS se queda corto»). `python tools/ui/textures.py` |
