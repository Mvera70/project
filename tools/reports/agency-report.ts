#!/usr/bin/env tsx
/**
 * Cuánto importa lo que hace el jugador. `docs/historico/plan-medios.md` §1, y la medida
 * que cierra cada fase de `docs/historico/rework.md` §4b (M-0 a M-4).
 *
 *   npx tsx tools/reports/agency-report.ts [--seeds 16] [--years 60] [--only nombre,nombre]
 *
