// Qué le pasa a un cuerpo, antes de tocar nada. docs/historico/rework.md §3.4.
//
...
// disciplina que `tools/reports/fate-report.ts` fijó para los pesos de los sucesos:
// medir primero, y volver a medir con el mismo informe después.
//
//   npx tsx tools/reports/life-report.ts [semillas...] [--days N]
//
