...
// el mismo espíritu que `tools/reports/life-report.ts` (IA-1) — «mide primero, no
...
//
//   npx tsx tools/reports/life-traits-report.ts [semillas...] [--days N] [--years N]
//
...
/** Cada cuánto se muestrea: un segundo escénico, igual que `tools/reports/life-report.ts`. */
