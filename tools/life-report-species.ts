// IA-4 · La evidencia que `tools/life-report.ts` no da: cuánto cuerpo-tiempo
// pasa cada especie en cada actividad, y cuántos sitios distintos usa un
// animal en una jornada.
//
// `tools/life-report.ts` no está entre los ficheros autorizados de esta fase
// (`docs/life-ai-implementation-prompt.md`, sección IA-4 del brief): mide las
// cuatro cifras de rework.md §3.4, comunes a personas y bestias, y no dice
...
//
//   npx tsx tools/life-report-species.ts [semillas...] [--days N]
//
