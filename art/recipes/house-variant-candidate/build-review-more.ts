...
// Segunda pareja aislada para revisión; catálogo y public/ quedan intactos.
const root = resolve(import.meta.dirname, '..', '..', '..');
const output = resolve(root, 'artifacts/graphics/house-variant-export-02');
...
const ids = ['house-hip-roof', 'stone-house-tower-loft'] as const;
...
console.log(`More house candidates exported to ${output}`);
