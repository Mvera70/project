...
manifest.generatedAt=new Date().toISOString();manifest.invocation='G-21: publicación selectiva por modelo';
fs.writeFileSync(path,JSON.stringify(manifest,null,2)+'\n');
fs.writeFileSync('artifacts/graphics/G-21/delivery/'+id+'-verification.json',JSON.stringify({status:'pass',id,statistics:a.statistics,bounds:a.bounds,approved:a.approved,sha256:entry.sha256,otherPublishedFilesUnchanged:true},null,2)+'\n');
