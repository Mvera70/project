...
|---|---|---|---|---|---|
| A1 · El cierre se ve y se celebra | Estado derivado «anillo cerrado» (`ringHasRoom` = no), entrada de crónica, cartela de hito en pantalla (§11.6) | **P1** | Baja-media | Sol | — |
| A2 · El portón | La puerta del anillo pasa de ser un cálculo (`defenceGates`) a un edificio con estado: abierto, cerrado, roto | P2 | Media | Sol | A1 |
...
| Fase | Qué | Prioridad | Dificultad | Agente | Depende de |
|---|---|---|---|---|---|
| B1 · La amenaza en el estado | Una presión que crece con plata, grano, ganado y decisiones (el principio de M-1 llevado al asedio); un flujo `raid`; cuándo y con qué tamaño llega la partida | **P1** | Media | Sol | — |
...
| B3 · Qué es «caer» | **Decisión del dueño**: saqueo con pérdida y la gente que queda sigue, o fin de partida. Después, el esquema (`ended.cause`, lo perdido) | **P1** (decidir) | Media | Dueño → Sol | — |
...
| Fase | Qué | Prioridad | Dificultad | Agente | Depende de |
|---|---|---|---|---|---|
| D1 · El motor de físicas | **Decisión**: ampliar lo que hay (círculos, `separate`, `resolve`, paso fijo) o meter Rapier/cannon-es; prototipo comparado con una toma del observatorio | **P1** | Alta | Astra | — |
| D2 · Flechas y aldeanos-torre | Balística con gravedad e impacto contra cuerpo y muralla; el aldeano en la muralla o la atalaya que dispara a lo que entra en alcance | P2 | Media | Sol | D1, C2 |
...
| E2 · Modelos del asedio | Enemigos (bandidos, soldados del señor), arco, flecha, espada, escudo | P2 | Alta | Astra · sesión de arte | — |
...
1. **Ahora, y a la vez** — A1 (el cierre se ve: barato y abre la fase 3), las
   dos decisiones del dueño **B3** (qué es caer) y **D1** (con qué físicas), y
   **E1** (los clips de combate, porque el arte tarda más que todo lo demás).
