...
| E0 · **Lo que todavía pasa y no se ve** · *Prepararse cerrado, 20 sep 2026* | El asalto, las armas, los arcos, la pelea, la rotura del portón, la huida, el saqueo y **la preparación de la aldea** ya tienen escena. Quedan el **aviso físico** en la loma, el pago de plata que sale, la **semana posterior** marcada, el derribo durante la segunda puerta y la transición estacada→piedra. También falta que la fase del valle cambie su ambiente. [Evidencia de E0a](historico/life-rounds/E0a-preparacion.md); inventario exacto en `docs/encargos-3d.md` §1 | **P1** | Media-alta | Astra (diseño) · Sol (capa de vida) | — |
