...
necesitan simplificación al calcar. La primera familia de crónica queda **6 de
6 como base**: fundación, nacimiento, muerte, boda y niño perdido en una hoja;
el rencor se repitió porque el primer pase sentaba a las figuras juntas. La
puerta acordada antes de generar las otras diecisiete es convertir estas seis
a SVG y verlas a 100 px en la crónica real. Generaciones y juicio en
