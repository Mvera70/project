...
| **A4 bloquea A5, y media C3** | Sol (motor) | **C3** (la atalaya como obra normal de §7.3) y **A5** (la fase del valle en la cabecera) están las dos marcadas `Depende de: A4`, la villa de piedra, que no está hecha. Se pararon el 18 sep, que es lo que la skill de ronda manda. **La mitad de C3 se salvó el mismo día**: la atalaya ya es una obra de §7.3 —la aldea se la levanta después del primer saqueo, a las 179 h de reloj— porque el edificio existía y no necesitaba A4. Lo que sigue esperándola son **las torres como mejora del anillo** (C3, segunda mitad) y **A5**, la fase del valle en la cabecera, que necesita la era (`hamlet · village · town`) que A4 define |
