...
| **UI-V7 - el juego ocupa la pantalla** | **hecha**. Tres sintomas que el dueno encontro en su tablet y que eran el mismo defecto: la pantalla se movia, el pellizco ampliaba la pagina en vez del valle, y no se podia girar.  topaba  a 390 x 844 desde U-01, y en un movil eso es la pantalla y no se nota; medido a 1240 x 1900 el juego era una columna en x 425 y la carcasa, que usa , ocupaba los 1240. Arreglado: caja a pantalla completa (el renderer reencuadra y **ensena mas valle**),  en el lienzo 3D —el 2D lo tenia y el 3D nacio sin el— y . Y lo que eso destapo: la piel esta medida a 390, asi que **la imagen va a sangre y el texto en su columna de 390**, con la barra cruzando la pantalla y sus celdas centradas. Se retira el rail lateral de 900 px de , que nunca se habia activado. En movil la geometria es identica pieza por pieza |  |
