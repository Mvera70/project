...
| **La era del valle** (A4, A5) | El valle es caserío, aldea o villa cerrada, y eso ya se puede preguntar (`derive/era.ts`) | La cabecera lo dice desde A5; E0e añade color de caminos existentes, bancos de plaza y humo más voluminoso según era | **Aceptación visual pendiente:** la misma escena controlada aún no permite clasificar las tres eras sin rótulo, sobre todo en tableta. No requiere malla nueva; [brief](encargos/encargo-e0-ambiente-eras.md) e [informe](historico/life-rounds/E0e-ambiente-eras.md) |
