...
| **El bastión** (`bastion`, A3, 22 sep 2026) | La torre en la línea de muralla | **G-26:** modelo 1×1 aprobado y publicado; la unión visible derecha no tiene hueco apreciable en una captura real. **G-27:** variante con 14 peldaños, huella 1×2 y respaldo G-26 cuando la celda interior no cabe; GLB y máscara de peatones integrados. La captura real no permite leer aún el detalle de la escalera. La guardia sigue en suelo: faltan subida y adarve navegables. [G-26](historico/graphics-rounds/G-26.md) · [G-27](historico/graphics-rounds/G-27.md) |
