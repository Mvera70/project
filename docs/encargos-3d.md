...
| **La avalancha en el portón** (D3b/D5) | Sesenta golpes y cede | **E1, 20 sep:** `gate_strike` desde cada golpe contado; `Gate.hitAt` fecha el contacto | **Reacción de puerta pendiente:** necesita edificios/renderer, fuera del alcance autorizado. Falta contacto preciso: el alcance mecánico es de grupo, no de mano |
...
| Qué | Estado |
|---|---|
| **Clips de combate** (E1) | **Parcial, 20 sep:** tensar, soltar, golpear portón y caer hechos por código. Faltan `spear_thrust`, `hit_take`, `flee` y reacción de puerta. [Informe](historico/life-rounds/E1-disparo-unico.md) |
