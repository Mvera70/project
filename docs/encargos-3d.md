...
| **La era del valle** (A4, A5) | El valle es caserío, aldea o villa cerrada, y eso ya se puede preguntar (`derive/era.ts`) | La cabecera lo dice desde A5; E0e añade color de caminos existentes, bancos de plaza, humo más voluminoso y tres acabados del empedrado según era | **Aceptación visual pendiente:** aldea/villa siguen parecidas en tableta. La misma escena controlada aísla el acabado, no sirve para clasificar eras históricas. El siguiente salto de contraste (tierra/empedrado parcial) requiere decidir si se revisa §7.4b; [brief](encargos/encargo-e0-ambiente-eras.md) e [informe](historico/life-rounds/E0e-ambiente-eras.md) |
