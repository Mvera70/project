...
| **La era del valle** (A4, A5) | El valle es caserío, aldea o villa cerrada, y eso ya se puede preguntar (`derive/era.ts`) | La cabecera lo dice desde A5; E0e añade color de caminos existentes, bancos de plaza y humo por era. §7.4b ya fija tierra pisada → piedra parcial → piedra completa en la plaza; tres grados distinguibles en controles móvil/tableta | **Aceptación histórica pendiente:** falta lectura independiente de eras reales sin rótulo. La piedra aún parece superficie lisa, no adoquín con juntas; si se exige ese detalle, necesitará arte de superficie. [Brief](encargos/encargo-e0-ambiente-eras.md) e [informe](historico/life-rounds/E0e-ambiente-eras.md) |
...
| **El bastión** (`bastion`, A3, 22 sep 2026) | La torre en la línea de muralla | **Modelo propio aprobado y publicado:** `art/recipes/bastion/bastion.json`, G-26; base 1×1, plataforma abierta, 1.092 triángulos, dos materiales y GLB con hash. El render usa `bastion.glb`; el muro reconoce al bastión vivo como vecino sin deformar la torre. La caja y el contacto se prueban con los GLB publicados, pero falta leer esa unión en la cámara real del juego: la primera captura móvil no incluía los bastiones y la toma amplia se bloqueó en Chrome. Sigue faltando el puesto elevado navegable. [Modelo](encargos/encargo-e3-modelo-bastion.md) · [integración](encargos/encargo-e3-integracion-bastion.md) |
