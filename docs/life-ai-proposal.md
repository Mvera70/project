...
Este fichero desarrolla las siguientes fases de `docs/rework.md` §3 y R-2/R-5.
...
el brief correspondiente de E.8 y `rework.md` §3–4. La interfaz se planifica en
...
El archivo `rework.md` estaba modificado al redactar esta propuesta. Sus medidas
...
`rework.md` documenta correcciones recientes de colisiones y giro, con residuos
...
verificar qué partes de `rework.md` ya se han completado. Las rutas de pruebas
...
Informes en `docs/life-rounds/IA-n.md`. El coordinador añade a cada brief la lista
...
hechos guardados. No se han editado código, pruebas, `rework.md` ni balance.
