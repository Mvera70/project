...
maneras distintas. `tools/reports/eligibility-report.ts` las separa: recorre la partida
...
Para repetir la medida: `npx tsx tools/reports/eligibility-report.ts 7 11 23 --years 60`.
