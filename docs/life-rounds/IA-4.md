...
**Las cuatro cifras de movimiento no se rompen** (`tools/life-report.ts`, 3
...
**Sitios distintos por animal y jornada** (`tools/life-report-species.ts`, nuevo).
...
3. volver a pasar `tools/life-report-species.ts` y exigir que lo suyo suba por
