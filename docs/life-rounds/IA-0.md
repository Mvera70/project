...
real de `docs/rework.md` §3.5 y quién es dueño de qué— y lo que la puerta de
...
**Herramienta de medida:** `tools/life-report.ts`
...
3. **Las nueve jornadas rojas de `docs/rework.md` §2.8** siguen rojas. Casi
