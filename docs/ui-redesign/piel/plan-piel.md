...
| **UI-V5 · encrucijada y epitafio** | el documento sellado como pantalla; precio al lado de cada opción (UI-R5); el epitafio con capitular oscura | `src/ui/screens/crossroad.ts`, `epitaph.ts` | comparativa contra la tarjeta sellada de 02; los recorridos de `tools/shots/valley.shots.ts` sobre la encrucijada siguen verdes |
