...
> en horas de reloj, con `tools/reports/pace-report.ts`.
...
que no salen nunca (`docs/medidas/findings-drama.md` §2) siguen sin salir, porque lo que les
...
- **La suite de balance.** Es lo caro: tarda 17,9 min por pasada y **ya falla
  diez pruebas antes de tocar nada** (`docs/medidas/findings-drama.md` §3). Con el tick siete
