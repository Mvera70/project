...
propone. Lo que se decida va a `docs/historico/rework.md` como fase nueva.
...
- Llegan dos veces por década y su consecuencia es un delta de estadística y
  una frase (`docs/historico/plan-juego.md` §1).
- **Diez de veinte plantillas no salen nunca** (`docs/medidas/findings-drama.md` §2, §7), así
...
la idea», `docs/historico/rework.md` §0.4). Lo que no se ha hecho es sacar la consecuencia:
...
nada», y medido sólo hacen daño. Se remide el balance (`docs/historico/rework.md` §5 lo tenía para después; aquí
...
**Lo siguiente:** convertir M-0, M-1 y M-2 en briefs de `docs/historico/rework.md` §4 con
