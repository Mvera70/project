...
`docs/historico/graphics-rounds/G-00.md` y `G-01.md`. No leas el historial completo ni G-03
...
Entrega `docs/historico/graphics-rounds/G-02.md` con comandos, árbol de outputs, hashes,
