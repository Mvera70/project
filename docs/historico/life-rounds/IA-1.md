...
4** de `docs/historico/rework.md` §3.5; el punto 5 (malla contra radio) es de
...
`npx tsx tools/reports/life-report.ts 7 23 97 --days 2`, sobre personas **y** animales,
...
(seis × cuatro, 92 160 cuerpo-segundos) está en `docs/historico/rework.md` §3.6 y es la
